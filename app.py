...
MONGODH_URI = os.environ.get("MONGODB_URI")
DB_NAME = os.environ.get("DB_NAME")

client = MongoClient(MONGODH_URI)
db = client[DB_NAME]

app = Flask(__name__)  

# password = 'sparta'
# cxn_str = f'mongodb+srv://test:{password}@cluster0.sxulqfe.mongodb.net/?retryWrites=true&w=majority'
